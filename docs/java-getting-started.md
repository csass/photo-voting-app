...
Rundoc.configure do |config|
  config.project_root = "photo-voting-app"
  config.filter_sensitive(email => "developer@example.com")
end
```
<!--
  rundoc src:
  https://github.com/heroku/photo-voting-app/blob/main/photo-voting-app.md

  Command:
  $ rundoc build --path photo-voting-app.md
-->
...
```term
:::>- $ git clone https://github.com/heroku/photo-voting-app
:::>- $ cd photo-voting-app
:::-- $ git fetch
...
The demo app you deployed already has a `pom.xml` ([see it here](https://github.com/heroku/photo-voting-app/blob/main/pom.xml)). Here's an excerpt:
...
[Here's the final source code](https://github.com/heroku/photo-voting-app/blob/localchanges/src/main/java/com/example/Main.java) for `Main.java` - yours should look similar.  [Here's a diff](https://github.com/heroku/photo-voting-app/compare/localchanges) of all the local changes you should have made.
