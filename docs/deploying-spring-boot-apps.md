...
<!--
  rundoc src:
  https://github.com/heroku/photo-voting-app/blob/main/deploying-spring-boot-apps.md
...
>note
>You can also start with a working [sample app](https://github.com/heroku/photo-voting-app) if you'd prefer.
